...
export const filtersSlice = createSlice({
  ...
  reducers: {
    ...
    setFilteredProducts: (state, action) => {
      console.log('p from f', state.products)
      state.filters.filteredProducts = action.payload
    }
  },
...
export const { increment, decrement, incrementByAmount, addCategory, removeCategory, toggleCategory, setPriceMin, setPriceMax, setFilteredProducts } = filtersSlice.actions;
